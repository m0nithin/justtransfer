    ...
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        {/* <ul className='list-none hidden sm:flex flex-row gap-10 justify-center items-center'>
          ...
          <li>
              <button className="rounded-[10px] w-fit p-3 bg-[#4907fd66] text-[#b4ffbe] border-transparent hover:text-white hover:bg-[#6e54ff]   transition duration-500 ease-in-out">
